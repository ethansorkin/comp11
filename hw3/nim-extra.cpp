...
*Problem 2
*
*EXTRA CREDIT STRATEGY: the computer will try to leave the user with certain
*						number of beans, so that they will usually win
*				#s to get opponent to: 1, 5, 9, 13, 17, 21, 25, 29
*
		...
		if (flip == 0)
		{
			...
			do
			{
				...
				if (num_beans > 0)
				{
						...
						//This is the strategy so the computer usually wins
						//#s to get opponent to: 1, 5, 9, 13, 17, 21, 25, 29
						if (num_beans == 4)
						{
							beans_taken = 3;
						...
						else if (num_beans == 10)
						{
							beans_taken = 1;
						}
						else if (num_beans == 11)
						{
							beans_taken = 2;
						}
						else if (num_beans == 12)
						{
							beans_taken = 3;
						}
						else 
